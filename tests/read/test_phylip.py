...
def test_read_dst(test_data):
    t1, m1 = read_dst(str(test_data / 'phylip_basic.dst'))
    t2, m2 = read_dst(str(test_data / 'phylip_tabstop.dst'), taxlen=0)
...
def test_read_scorer(test_data):
    scorer = read_scorer(str(test_data / 'dolgo.matrix'))
