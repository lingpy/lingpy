...
def test_read_asjp(test_data):
    lex = LexStat(read_asjp(
        str(test_data / 'asjp_test_list.csv'), family='CELTIC',
...
def test_csv2list(test_data):
    if_path1 = str(test_data / 'test_csv.csv')
    if_path2 = str(test_data / 'test_csv')
...
def test_csv2multidict(test_data):
    if_path1 = str(test_data / 'test_csv.csv')
